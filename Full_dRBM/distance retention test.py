...
from setup_input import irish_input, setup_network, setup_data
...
for i in range(200):
    ...
    for _ in range(steps):
        new_nodes_connections[0] = irish_input(new_nodes_connections[0], new_data)
    ...
    test_vowel = "make this the input word?"
