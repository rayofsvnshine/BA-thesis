"""
Tests the activation of the input layer and returns the highest
activated node for each group (phonemes/lexemes/case/definiteness/plurality).
"""
...
def check_activation(activation_layer):
    """ Iterates over all nodes and selects the highest activated node
        for each group (phonemes/lexemes/case/definiteness/plurality).
    """
    activated_nodes = []
