...
def main():
    ...
    # # save results to csv
    # results.to_csv('../results/processed/test_full_prod_results.csv', ',')
    ...
    # save results to csv
    case_results.to_csv('../results/processed/test_full_comp_phon_case_results.csv', ',')

    # group total plurality results
    plur_results = plur_results.groupby(['Act. Out. Lex', 'Act. Out. Phon','Act. Out. Plur']).sum(['0'])
    # save results to csv
    plur_results.to_csv('../results/processed/test_full_comp_phon_plur_results.csv', ',')

    # group total definiteness results
    def_results = def_results.groupby(['Act. Out. Lex', 'Act. Out. Phon','Act. Out. Def']).sum(['0'])
    # save results to csv
    def_results.to_csv('../results/processed/test_full_comp_phon_def_results.csv', ',')
