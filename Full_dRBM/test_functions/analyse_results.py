...
def main():
    ...
    for i in range(100):
        ...
        with open(f"../results/full/prod/test_full_prod_{i}.csv") as f:
    ...
    # save results to csv
    results.to_csv('../results/test_full_prod_results.csv', ',')
    ...
    for i in range(100):
        ...
        with open(f'../results/full/comp/test_full_comp_{i}.csv') as f:
        ...
        comp_results[['Act. Out. Case', 'Act. Out. Plur', 'Act. Out. Def']] = comp_results['Actual Output'].str.split(',', expand=True).dropna(axis=1)
