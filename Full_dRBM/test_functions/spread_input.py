...
def middle_spread(new_nodes, new_connections):
    ...
    new_nodes[1][0,:] = new_nodes[1][1,:] + inp_act_weight + top_act_weight
...
def top_spread(new_nodes, new_connections):
    ...
    new_nodes[2][0,:] = new_nodes[2][1,:] + mid_act_weight
...
def middle_to_bottom_spread(new_nodes, new_connections):
    ...
    # store new activations
    # new_nodes[0][0,:] = np.random.binomial(1, 1 / (1 + np.exp(-(new_nodes[0][1,:] + mid_act_weight))))
