...
def input_test_word(new_nodes, testing_dataset, comp_or_prod, step):
    """ This function chooses a random test word and changes the 
        activations on the input layer accordingly
    ...
    random_index = step
    random_word = testing_dataset.loc[random_index]
